  ...
  return (
    <div className="page-content">
      <div className="page-header d-flex align-items-center gap-3">
        ...
        <h1 className="page-title">Bottle Specification Detailed</h1>
      </div>
            ...
            <table className="table mb-0 align-middle">
              <thead className="bg-light">
                <tr>
                  ...
                  <th className="px-4 py-3 text-uppercase small fw-bold text-muted" style={{ fontSize: 11 }}>Capacity</th>
                  <th className="px-4 py-3 text-uppercase small fw-bold text-muted" style={{ fontSize: 11 }}>Units/Box</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-4">{spec.quantity} {spec.quantityUnit}</td>
                  <td className="px-4 py-4">{spec.unitPerBox}</td>
                  <td className="px-4 py-4">
                    <span className="fw-500">{spec.printingType}</span>
                    <br/><small className="text-muted">{spec.printingSubType}</small>
                  </td>
                  <td className="px-4 py-4">
