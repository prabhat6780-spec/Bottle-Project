              ...
              {paginatedItems.map((v, index) => (
                <tr key={v._id} className="align-middle border-bottom transition-all hover-bg-light">
                  ...
                  <td className="py-3 text-center">
                    {v.image ? (
                      <img src={`${import.meta.env.VITE_BACKEND_URL || "https://application.shayonaglass.com"}${v.image}`} alt="Variant" style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: 8 }} />
                    ) : (
