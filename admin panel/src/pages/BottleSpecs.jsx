                ...
                <tr key={s._id} className="align-middle transition-all hover-bg-light border-bottom">
                  ...
                  <td className="py-3">
                    <div className="d-flex align-items-center">
                      <div className="icon-box bg-light text-accent rounded-3 me-3 d-flex align-items-center justify-content-center" style={{ width: 42, height: 42 }}>
                        <i className="bi bi-droplet-fill" style={{ fontSize: 18 }} />
                      </div>
                      <div>
